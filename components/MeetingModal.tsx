...
<Dialog open={isOpen} onOpenChange={onClose}>
  <DialogContent className='flex w-full max--[520px] flex-col gap-6 border-none bg-dark-1 px-6 py-9 text-white'>
	...
	<h1 className={cn('text-3x; font-bold leading-4]', className)}> 
		{title}
	</h1>
	{children}
